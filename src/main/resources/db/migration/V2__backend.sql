...
DROP SEQUENCE IF EXISTS officesequence;
CREATE SEQUENCE officesequence INCREMENT 1 MINVALUE 1 MAXVALUE 9223372036854775807 CACHE 1;

DROP SEQUENCE IF EXISTS pinsequence;
CREATE SEQUENCE pinsequence INCREMENT 1 MINVALUE 1 MAXVALUE 9223372036854775807 CACHE 1;

DROP SEQUENCE IF EXISTS refnosequence;
CREATE SEQUENCE refnosequence INCREMENT 1 MINVALUE 1 MAXVALUE 9223372036854775807 CACHE 1;

DROP SEQUENCE IF EXISTS syssequence;
CREATE SEQUENCE syssequence INCREMENT 1 MINVALUE 1 MAXVALUE 9223372036854775807 CACHE 1;

DROP SEQUENCE IF EXISTS tokensequence;
CREATE SEQUENCE tokensequence INCREMENT 1 MINVALUE 1 MAXVALUE 9223372036854775807 CACHE 1;

DROP SEQUENCE IF EXISTS transactionsequence;
CREATE SEQUENCE transactionsequence INCREMENT 1 MINVALUE 1 MAXVALUE 9223372036854775807 CACHE 1;

DROP SEQUENCE IF EXISTS transequence;
CREATE SEQUENCE transequence INCREMENT 1 MINVALUE 1 MAXVALUE 9223372036854775807 CACHE 1;

DROP SEQUENCE IF EXISTS usersequence;
CREATE SEQUENCE usersequence INCREMENT 1 MINVALUE 1 MAXVALUE 9223372036854775807 CACHE 1;